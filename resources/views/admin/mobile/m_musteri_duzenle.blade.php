...
<form action="{{url('/')}}/mobile/musteri/update/{{$musteri[0]->id}} " method="post" enctype="multipart/form-data"
      class="form-horizontal">
    @csrf
    <div class="form-group">
        <label for="inputEmail4" class="col-form-label">Müşteri Adı</label>
        <input type="text" class="form-control" value="{{$musteri[0]->musteriadi}}" name="musteri_adi" id="musteri_adi"
               placeholder="Müşteri Adı" required>
    </div>

    <div class="form-group">
        <label for="inputPassword4" class="col-form-label">Telefon</label>
        <input type="text" class="form-control" value="{{$musteri[0]->tel}}" name="musteri_tel" id="musteri_tel"
               placeholder="Telefon">
    </div>
    ...
    <div class="form-group">
        ...
        <select name="musteri_adres" id="musteri_adres" class="form-control">
            <option value="{{$musteri[0]->adres}}" selected> {{$musteri[0]->adres}} </option>
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-success  btn-block mb-1">
            <i class="simple-icon-check"></i> Güncelle
        </button>
    </div>
</form>
