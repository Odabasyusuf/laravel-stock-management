            ...
            <div class="card-body">
                ...
                <div class="scroll dashboard-list-with-user">
                    <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                        <a href="#">
                            <img alt="Profile Picture" src="{{url('/')}}/assets/admin/mobile/img/profiles/l-1.jpg"
                    ...
                    <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                        <a href="#">
                            <img alt="Profile Picture" src="{{url('/')}}/assets/admin/mobile/img/profiles/l-7.jpg"
                                 class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                        </a>
                        <div class="pl-3">
                            <a href="#">
                    ...
                    <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                        <a href="#">
                            <img alt="Profile Picture" src="{{url('/')}}/assets/admin/mobile/img/profiles/l-6.jpg"
                                 class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                        </a>
                        <div class="pl-3">
                            <a href="#">
                    ...
                    <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                        <a href="#">
                            <img alt="Profile Picture" src="{{url('/')}}/assets/admin/mobile/img/profiles/l-3.jpg"
                                 class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                        </a>
                        <div class="pl-3">
                            <a href="#">
                    ...
                    <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                        <a href="#">
                            <img alt="Profile Picture" src="{{url('/')}}/assets/admin/mobile/img/profiles/l-5.jpg"
                                 class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                        </a>
                        <div class="pl-3">
                            <a href="#">
                    ...
                    <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                        <a href="#">
                            <img alt="Profile Picture" src="{{url('/')}}/assets/admin/mobile/img/profiles/l-4.jpg"
                                 class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                        </a>
                        <div class="pl-3">
                            <a href="#">
